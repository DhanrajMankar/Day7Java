...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(winAmount>loseAmount)
		{
			...
			System.out.println("Your net earning is for 30 days= "+netAmount);
		}
		if(winAmount<loseAmount)
		{
			netAmount=loseAmount-winAmount;
			System.out.println("Your net lose is for 30 days= "+netAmount);
		}
		if(winAmount==loseAmount)
		{
